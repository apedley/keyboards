...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ADJUST] =  LAYOUT(
      ...
      _______, RGB_HUI, RGB_SAI, RGB_VAI,  QWERTY, AG_SWAP, _______, _______, _______, _______, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI,
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ADJUST] =  LAYOUT(
      _______, QK_BOOT, RGBRST, _______, _______, _______,                   _______, _______, _______, _______, _______, KC_DEL,
      _______, RGB_TOG, RGB_MOD, AU_ON,   AU_OFF,  AG_NORM,                   AG_SWAP, QWERTY,  COLEMAK, DVORAK,  _______, _______,
      _______, _______, _______, _______, _______, AG_SWAP,                   _______, _______, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI,
