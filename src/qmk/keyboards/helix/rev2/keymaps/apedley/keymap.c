...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ADJUST] =  LAYOUT(
      ...
      _______, QK_BOOT, _______, _______, _______, _______,                   RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, _______, _______,
      KC_CAPS, KC_MAKE, _______, _______, _______, _______,                   RGB_TOG, RGB_HUD, RGB_SAD, RGB_VAD, _______, _______,
...
bool process_record_keymap(uint16_t keycode, keyrecord_t *record) {m
  switch (keycode) {
