...
[MAC_BASE] = LAYOUT_ansi_68(
     ...
     KC_LCTL,  KC_LOPTN, KC_LCMMD,                               KC_SPC,                       KC_RCMMD,MO(MAC_FN1),TT(FN2), KC_LEFT,  KC_DOWN, KC_RGHT),
...
[WIN_BASE] = LAYOUT_ansi_68(
     ...
     KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,    KC_RCTL,
     KC_LCTL,  KC_LGUI,  KC_LALT,                                KC_SPC,                       KC_RALT, MO(WIN_FN1),TT(FN2), KC_LEFT,  KC_DOWN, KC_RGHT),
...
[FN2] = LAYOUT_ansi_68(
     _______,  BT_HST1,    BT_HST2,    BT_HST3,    BAT_LVL,    _______,    _______,    _______,    TOGNP,    RGB_SAI,    RGB_HUI ,   RGB_VAI, RGB_SPI,  RGB_TOG,  RGB_MOD,
     _______,  KC_WH_U,  KC_MS_U,  KC_WH_D,  KC_BTN2,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  QK_RBT,  QK_BOOT,  KC_MAKE,
     TG(FN2),  KC_MS_L,     KC_MS_D,     KC_MS_R,     KC_BTN1,    _______,     _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,
     _______,  KC_WH_L,  KC_BTN3,  KC_WH_R,  KC_BTN3,  _______,  _______,  _______,  _______,  _______,  SEND_RAW,  _______,            KC_VOLU,  _______,
