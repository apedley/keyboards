...
#define RAISETAB LT(_RAISE, KC_TAB)
...
#define AP_REDO C(S(KC_Z))
#define AP_UNDO C(KC_Z)
#define AP_REDOY C(KC_Y)
 ...
 *                                                                               generated by [keymapviz] */
    ...
    RAISETAB,    HOME_A,    HOME_S,   CTL_D,   SFT_F, KC_G,          KC_H,    SFT_J,  CTL_K,    HOME_L,   HOME_SCLN, LOWRQT,
    KC_LSFT,  RAISEZ,     KC_X,   KC_C,     KC_V,   KC_B,          KC_N,    KC_M,    KC_COMM,  KC_DOT, KC_SLSH,   KC_RSFT,
                KC_MUTE,        LOWER,   KC_SPC, KC_RCTL,          KC_LALT,  KC_ENT, RAISE,          KC_MUTE,
                                KC_MPRV, KC_MPLY, KC_MNXT,         AP_REDO, AP_REDOY, AP_UNDO
    ),
 ...
 *                                                                               generated by [keymapviz] */
    [_RAISE] = LAYOUT_ximi(
    KC_F11,  KC_HOME,  KC_UP,   KC_END,   KC_PGUP, _______,    KC_BTN1, KC_BTN2, _______, KC_HOME, SELWORD, KC_PGUP,
    SELWORD,  KC_LEFT, KC_DOWN, KC_RIGHT, KC_PGDN, SELWORD,    _______, _______, _______, KC_END, KC_UP,    KC_PGDN,
 ...
 *                                                                               generated by [keymapviz] */
    ...
    _______,  _______, _______, _______, _______, FP_SNIPE_TOG,   KC_BTN1, KC_BTN2,      _______, _______, FP_SCROLL_DPI_DN, FP_SNIPE_DPI_DN,
...
// #if defined(RGB_MATRIX_ENABLE) && defined(RGB_MATRIX_UNDERGLOW_INDICATORS)
//   if (caps_word_active) {
//     HSV hsv = {
//       .h = 40,
//       .s = 255,
