 ...
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * | TAB  | GUI  |  S   | CTRL |SHIFT |  G   |                |  H   |SHIFT | ALT  |  L   | GUI  | ' "  |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * | LSFT |RAISEZ|  X   |  C   |  V   |  B   |                |  N   |  M   | , <  | . >  | / ?  | RSFT |
 * `------+------+------+------+------+------+------.  ,------+------+------+------+----+--------+------'
 *          | Mute |           |LOWER |Space | LALT |  | RCTL | ENT  |RAISE |           | Mute |
 *          `------'           `--------------------'  `--------------------'           `------'
 *
...
/* ,-----------------------------------------.                ,-----------------------------------------.
 * | F11  | HOME |  UP  | END  | PGUP |      |                |Mouse1|Mouse2| WH_D | WH_U |      |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |SELWOR| LEFT | DOWN |RIGHT | PGDN |SELWOR|                | MS_L | MS_D | MS_U | MS_R |  UP  |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 ...
 *                                                                               generated by [keymapviz] */
    ...
    RGB_TOG, RGB_RMOD,RGB_SPD, RGB_HUD, RGB_SAD, RGB_VAD,    KC_CAPS,  _______,    _______, _______, _______, _______,
...
/* ,-----------------------------------------.                ,-----------------------------------------.
 * |      |      |      |      |      |      |                |Mouse1|Mouse2|      |Accel | Zoom |Snipe |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |      |      |      |      |      |      |                |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |      |      |      |AP_TPR|AP_TNX|AP_TCL|                |Mouse4|Mouse5|      |Accel | Zoom |Snipe |
 * `------+------+------+------+------+------+------.  ,------+------+------+------+----+--------+------'
 ...
 *                                                                               generated by [keymapviz] */
    [_MOUSE] =  LAYOUT_ximi(
    _______,  _______, _______, _______, _______, _______,                KC_BTN1, KC_BTN2, _______, _______, _______, FP_SNIPE_TOG,
    _______,  _______, _______, _______, _______, FP_ZOOM_TOG,            FP_SNIPE_TOG, _______, _______, _______,  _______,  _______,
    _______,  _______, _______, AP_TCLS, AP_TPRV, AP_TNXT,                KC_BTN4, KC_BTN5, _______, _______, _______, FP_ZOOM_TOG,
                _______,        _______, _______, _______,                _______, _______, _______,       _______,
                                _______, _______, _______,                _______, _______, _______
    )
};
