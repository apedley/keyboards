...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT(
              ...
              KC_P7,    KC_P8,    KC_P9,    KC_PPLS,  KC_VOLU, KC_1,
              KC_P4,    KC_P5,    KC_P6,    KC_PENT,  KC_MUTE, KC_1,
    FN1,      KC_P1,    KC_P2,    KC_P3,    KC_RSFT,  KC_VOLD, KC_2,
    FN1,      KC_RCTL,  KC_P0,     KC_PDOT,  KC_RALT, KC_2,    KC_1
  ),
  [_FN1] = LAYOUT(
